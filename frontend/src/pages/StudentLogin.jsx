            ...
            <div className="max-w-4xl w-full bg-white/95 dark:bg-slate-800/95 backdrop-blur-xl rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row overflow-hidden border border-white/20 dark:border-slate-700/50 animate-in fade-in zoom-in duration-500 relative">
                ...
                <div className="w-full md:w-80 bg-slate-900 p-12 text-white flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-[0.2em] mb-8">Student Portal</p>
                        <p className="text-slate-300 text-sm leading-relaxed">Please authenticate to access your personal dashboard and residents services.</p>
                    </div>
                </div>
                ...
                <div className="flex-1 p-10 md:p-16">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mt-1">Authenticate Resident Account</p>
                    </div>
                    ...
                    <p className="mt-8 text-center text-sm text-slate-500 dark:text-slate-400 font-medium">
                        New here? <Link to="/register" className="text-indigo-600 font-bold hover:text-indigo-700">Create account</Link>
                    </p>
                </div>
            </div>
        </div>
